...
namespace _2025_2C_ReservaEspectaculoORT.Controllers
{
    ...
    public class SalasController : Controller
    {
        ...
        public SalasController(ReservaEspectaculoContext context)
        {
            _context = context;
        }
        ...
        {
            var reservaEspectaculoContext = _context.Sala.Include(s => s.TipoSala);
        ...
        public async Task<IActionResult> Create([Bind("CapacidadButacas,Id,Numero,TipoSalaId")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CapacidadButacas,Id,Numero,TipoSalaId")] Sala sala)
        {
            if (id != sala.Id)
            {
                return NotFound();
