...
namespace _2025_2C_ReservaEspectaculoORT.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public EmpleadosController(ReservaEspectaculoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("legajo,id,Apellido,Direccion,Dni,Email,FechaAlta,Nombre,Telefono,UserName")] Empleado empleado)
        {
