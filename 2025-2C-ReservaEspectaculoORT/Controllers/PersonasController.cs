...
namespace _2025_2C_ReservaEspectaculoORT.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public PersonasController(ReservaEspectaculoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Apellido,Direccion,Dni,Email,FechaAlta,Nombre,Telefono,UserName")] Persona persona)
        {
